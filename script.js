...
function getSavedColumns() {
  if (localStorage.getItem('backlogItems')) {
    ...
    backlogListArray = ['morning team meeting', 'coffee time'];
    progressListArray = ['pair programming', 'snack time'];
    completeListArray = ['double check projects', 'Gym'];
    onHoldListArray = ['Debugging'];
  }
}
...
// add to colum list, reset textbox
